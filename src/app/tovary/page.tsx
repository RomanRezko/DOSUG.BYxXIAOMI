  ...
  return (
    <div style={{ background: 'var(--color-background-alt)' }}>
      ...
      <section className="hero noise-overlay">
        <div className="container hero-content" style={{ padding: '48px 24px 56px' }}>
          <span className="tag tag--green">Спецпредложения</span>
          <h1
            className="text-display mt-4"
            style={{ color: '#fff', maxWidth: 720 }}
          >
            Xiaomi со скидкой
          </h1>
          <p
          ...
          >
            Умная техника для дома по ценам ниже обычных. {products.length} товаров
            в акции — только оригинальная продукция с гарантией.
          </p>
        </div>
      </section>

      <div id="catalog" className="container scroll-mt-24" style={{ padding: '40px 24px 96px' }}>
