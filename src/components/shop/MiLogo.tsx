...
/**
 * Логотип Xiaomi (Mi) — официальная геометрия (Xiaomi 2021).
 * Оранжевый squircle (#FF6900) + белая монограмма «MI».
 * Пути взяты 1:1 из официального вектора, viewBox сохранён.
 * Используется в ко-брендовой коллаборации DOSUG.BY × Xiaomi.
 */
export function MiLogo({ size = 64, className }: MiLogoProps) {
  return (
    <svg
      width={size}
      height={size}
